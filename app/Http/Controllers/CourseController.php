        ...
        if (! $course->is_audit) {
            ...
            if ($newTotal !== $level->total_credits) {
                ...
                return back()->withErrors([
                    'credits' => "Credits must keep the level total exactly {$level->total_credits}. 
                        Other courses already use {$currentCredits}, so this course must have {$remainingCredits} credits."
                ]);
            }
        }
