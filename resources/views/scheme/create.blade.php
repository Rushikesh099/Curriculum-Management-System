...
@section('content')
    ...
    <form action="{{ route('scheme.store') }}" method="POST">
        ...
        <div class="form-check mb-3">
            <input type="checkbox" id="auditToggle" name="audit_enabled" value="1" class="form-check-input">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addLevelBtn.addEventListener('click', function() {
                ...
                let templateRow = document.querySelector('.level-row');
            ...
            document.addEventListener('click', function(e) {
                ...
                if (e.target.classList.contains('removeRow')) {
                    ...
                    // Prevent deleting the last remaining level
                    if (rows.length === 1) {
