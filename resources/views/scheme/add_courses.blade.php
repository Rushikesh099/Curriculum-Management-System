...
@section('content')
    ...
    <form method="POST"
        action="{{ route('scheme.storeCourses', ['scheme' => $scheme->id, 'level' => $schemeLevel->id]) }}">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" name="courses[{{ $i }}][course_code]"
                                    class="form-control">
                            </div>

                            <div class="col-md-5">
                                <label>Course Title</label>
                                <input type="text" name="courses[{{ $i }}][course_title]"
                                    class="form-control">
                            </div>
                            ...
                            @if (!$schemeLevel->is_audit)
                                <div class="form-check mt-2">
                                    <label>
                                        ...
                                        <input type="checkbox" name="courses[{{ $i }}][is_award]" value="1"
                            ...
                            <!-- TEACHING SCHEME -->
                            <div class="border rounded p-3 mb-3 bg-light mt-3">
                                <h6 class="mb-3">Teaching Scheme</h6>
                                <div class="row">

                                    <div class="col-md-2">
                                        <label>TH</label>
                                        <input type="number" name="courses[{{ $i }}][th]"
                                            class="form-control th-input">
                                    </div>

                                    <div class="col-md-2">
                                        <label>TU</label>
                                        <input type="number" name="courses[{{ $i }}][tu]"
                                            class="form-control tu-input">
                                    </div>

                                    <div class="col-md-2">
                                        <label>PR</label>
                                        <input type="number" name="courses[{{ $i }}][pr]"
                                            class="form-control pr-input">
                                    </div>

                                    <div class="col-md-3">
                                        <label>Total Hours</label>
                                        <input type="number" name="courses[{{ $i }}][total_hours]"
                                            class="form-control total-hours-input" readonly>
                                    </div>

                                    @if (!$schemeLevel->is_audit)
                                        <div class="col-md-3">
                                            <label>Credits</label>
                                            <input type="number" name="courses[{{ $i }}][credits]"
                                                class="form-control">
                                        </div>
                                    @endif
                                ...
                                <div class="border rounded p-3 bg-white">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" name="courses[{{ $i }}][theory_hours]"
                                                class="form-control">
                                        </div>

                                        <div class="col-md-2">
                                            <label>Theory Marks</label>
                                            <input type="number" name="courses[{{ $i }}][theory_marks]"
                                                class="form-control theory-marks">
                                        </div>

                                        <div class="col-md-2">
                                            <label>Test Marks</label>
                                            <input type="number" name="courses[{{ $i }}][test_marks]"
                                                class="form-control test-marks">
                                        </div>

                                        <div class="col-md-2">
                                            <label>PR Marks</label>
                                            <input type="number" name="courses[{{ $i }}][pr_marks]"
                                                class="form-control pr-marks">
                                        </div>

                                        <div class="col-md-2">
                                            <label>OR Marks</label>
                                            <input type="number" name="courses[{{ $i }}][or_marks]"
                                                class="form-control or-marks">
                                        </div>

                                        <div class="col-md-2">
                                            <label>TW Marks</label>
                                            <input type="number" name="courses[{{ $i }}][tw_marks]"
                                                class="form-control tw-marks">
                                        </div>

                                        <div class="col-md-3 mt-3">
                                            <label>Exam Total</label>
                                            <input type="number" name="courses[{{ $i }}][exam_total]"
                                                class="form-control exam-total" readonly>
                                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let typeFields = document.querySelectorAll(".course-type");

        if (typeFields.length > 0) {

            typeFields.forEach(select => {
