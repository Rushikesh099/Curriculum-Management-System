        ...
        <form action="{{ route('courses.update', $course->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" name="Abbr" class="form-control" value="{{ $course->Abbr }}">
                </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="electiveGroupDiv">
                            ...
                            <select name="elective_group">
                                ...
                                <option value="1" {{ $course->elective_group == 1 ? 'selected' : '' }}>Elective 1
                                </option>
                                <option value="2" {{ $course->elective_group == 2 ? 'selected' : '' }}>Elective 2
                                </option>
                                <option value="3" {{ $course->elective_group == 3 ? 'selected' : '' }}>Elective 3
                                </option>
                                <option value="4" {{ $course->elective_group == 4 ? 'selected' : '' }}>Elective 4
                                </option>
                        ...
                        <div class="form-check mt-2">
                            ...
                            <input type="checkbox" name="is_award" value="1" class="form-check-input"
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <label>TH</label>
                    <input type="number" name="th" class="form-control th-input" value="{{ $course->th }}">
                </div>

                <div class="col-md-2">
                    <label>TU</label>
                    <input type="number" name="tu" class="form-control tu-input" value="{{ $course->tu }}">
                </div>

                <div class="col-md-2">
                    <label>PR</label>
                    <input type="number" name="pr" class="form-control pr-input" value="{{ $course->pr }}">
                </div>
            ...
            @if (!$course->is_audit)
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" name="theory_hours" class="form-control" value="{{ $course->theory_hours }}">
                    </div>
